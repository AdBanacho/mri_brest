...
from mriBreastDuke.constants import DCM_PATH


folder_list = []

for item in os.listdir(DCM_PATH):
    full_path = os.path.join(DCM_PATH, item)
...
print("Number of series:", len(series_uids))
